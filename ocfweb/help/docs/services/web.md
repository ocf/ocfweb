...
Group accounts may also request a [[virtual host|help services/vhost]] for
...
1. Login to your account via [[SSH|help services/shell]].
...
account|help services/shell]] (typically SFTP if used remotely). The only
...
Access and error logs are accessible in `/opt/httpd` using
[[SSH|help services/shell]].
