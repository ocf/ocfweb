...
Your OCF account is both proof of your [[membership|help membership]] and the means by which you authenticate to the variety of [[services|help services]] operated by OCF [[staff|help staff]]. Your OCF account is independent from CalNet. (Technical info: public account information and salted password hashes are stored in [[LDAP|help staff/backend/ldap]] and [[Kerberos|help staff/backend/kerberos]] databases, respectively.)

Accounts are not normally deactivated after your membership
[[eligibility|help membership/eligibility]] expires (e.g., graduation). In fact, we have active
...
Use [[SSH|help services/shell]] to run the command `passwd` and follow the prompts as shown below. No text will appear when you are entering in a password, just press enter when done after each prompt.
...
Please bring sufficient documentation as listed on the [[membership eligibility|help membership/eligibility]] page to demonstrate that you are authorized to reset the account password.
...
You have two choices:
  ...
  * **Option 2 (postal mail).** Mail your documentation to our [[mailing
    address|help contact#index6h2]]. Expect a delay of at least 2-3 weeks,
...
Access to your [[MySQL database|help services/mysql]], if you have one, is protected by a separate password.
...
If you want to disable your OCF account, please [[contact us|help contact]] and provide your OCF username. If your account appears to still be active, we may ask for some evidence that you are the account owner. Currently, disabled accounts are stored or archived and can be *re-enabled* by request at a later date. Disabled accounts may eventually be scheduled for deletion.
