...
All accounts include our [[standard web hosting|help services/web]], which is
...
domain names|help services/vhost]]* (either group.berkeley.edu, or your own
...
account|help membership]]. Once you have an account, email `hostmaster@ocf` with at
...
All [[normal requirements for virtual hosts|help services/vhost]] apply. In
...
Probably. [[Send us an email|help contact]], and be sure to provide the name of the
...
A [[MySQL database|help services/mysql]] is included with your OCF account. You
...
from outside of the OCF. You could come work from [[the lab|help services/lab]], or
