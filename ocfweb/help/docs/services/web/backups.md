...
You can make easy-to-restore backups over [[SSH|help services/shell]] by following
...
Instructions are on the [[MySQL|help services/mysql]] page, but the basic syntax
to make a backup is
...
[[follow our instructions|help services/mysql]] to create `~/.my.cnf` which will
