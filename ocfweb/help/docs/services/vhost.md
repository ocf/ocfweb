...
1.   [[Request an OCF group account|help membership]] (if you haven't already done so).
...
3.   Place a [[Hosted by OCF banner|help services/vhost/badges]] on your home page that links to the OCF front page. If none of these images are appropriate for your site, you may design one of your own and [[submit it|help contact]] for approval.
...
Place any of the [[Hosted by OCF banners|help services/vhost/badges]] on your site by copying the code onto your page. The banner is required to be placed only on the home page of your site. You can also create your own OCF banner with approval from the OCF (see instructions above).
...
[[SSH|help services/shell]]. Once logged in, you can create the files by executing a
command like:
